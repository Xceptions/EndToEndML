...
2. Create the K3d Cluster exposing two ports:
...
3. Import images directly into k3d using imagePullPolicy:
...
5. Navigate to http://localhost:8080 for frontend and port 8081 for querying backend.